namespace CHEJ_GetServicesVzLa.Helpers
{
    ...
    public class MethodsHelper
    {
        ...
        {
            return Application.Current.Resources["CompanyName"].ToString().Trim();
        }

        public static string GetCompanyUrl()
        {
            return Application.Current.Resources["CompanyUrl"].ToString().Trim();
        }

        public static string GetCompanyEmail()
        {
            return Application.Current.Resources["CompanyEmail"].ToString().Trim();
        }
